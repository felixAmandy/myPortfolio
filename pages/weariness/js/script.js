...
const activities = [
    ...
    { title: "Criação de memes e Fotografias engraçadas", description: "Se você gosta de humor e tem facilidade para criar conteúdo visual ou textual, pode criar memes ou posts criativos para plataformas.", category: "criativa", effort: "baixo", company: "em grupo" },
    { title: "Jogos de improvisação", description: "Criar jogos rápidos de improvisação, onde as pessoas precisam pensar rápido e ser criativas com suas respostas.", category: "criativa", effort: "baixo", company: "em grupo" },
    ...
    { title: "Pintura ou Desenho Livre", description: "Onde você pode se expressar artisticamente sem pressões.", category: "relaxante", effort: "baixo", company: "sozinho ou em grupo" },
    { title: "Jardinagem", description: "Cuidar de plantas ou flores, seja no seu jardim ou dentro de casa", category: "relaxante", effort: "baixo", company: "sozinho ou em grupo" },
